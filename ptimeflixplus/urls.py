...
from Primeflix.views import addFilme, addEp, addSerie, cadGenero, delete, deleteep, loginUsuario, main, series, cadUsuario, update, updateEp, verTtulos, viewTitulo
